...
export declare class BaseIonicAuth implements IIonicAuth {
    signIn(loginHint?: string): void;
    signOut(): void;
    getUserInfo<T>(): Promise<T>;
    startUpAsync(): Promise<void>;
...
export declare const NullIonicAuthObject: IIonicAuth;
export declare class IonicAuth implements BaseIonicAuth {
    ...
    protected onImplicitNotification(request: ImplicitRequest, response: TokenResponse | null, error: TokenError | null): Promise<void>;
